...
export async function editProject(id: string, name: string, code: string, color: string, priority: number) {
  const result = updateProject(id, { name, code, color, priority });
